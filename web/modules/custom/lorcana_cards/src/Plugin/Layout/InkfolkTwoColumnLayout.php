...
/**
 * Two-column section layout with configurable top/bottom spacing.
 *
 * Replaces core's layout_twocol_section class via hook_layout_alter(); keeps
 * the inherited column-width setting.
 */
final class InkfolkTwoColumnLayout extends TwoColumnLayout {
