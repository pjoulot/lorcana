...
/**
 * One-column layout with configurable top/bottom spacing.
 *
 * Replaces core's layout_onecol class via hook_layout_alter().
 */
final class InkfolkOneColumnLayout extends LayoutDefault {
